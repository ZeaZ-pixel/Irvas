...
Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('#timer', '2021-08-30');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return checkNum; });
...
/* harmony import */ var _checkNum__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./checkNum */ "./src/js/modules/checkNum.js");
...
function form(state) {
  var formSection = document.querySelectorAll('form');
  var message = {
    loading: 'Loading...',
    success: 'Success',
    failure: 'Error'
  };
  Object(_checkNum__WEBPACK_IMPORTED_MODULE_9__["default"])('input[name="user_phone"]');
  formSection.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      var object = JSON.stringify(Object.fromEntries(formData.entries()));

      if (e.target.classList.contains('main_form')) {
        Object(_service_service__WEBPACK_IMPORTED_MODULE_8__["postData"])('http://localhost:3000/free_measurement', object).then(function (data) {
          console.log(data);
          showThanksModal('.popup', message.success);
        }).catch(function () {
          showThanksModal('.popup', message.failure);
        }).finally(function () {
          Object(_modals__WEBPACK_IMPORTED_MODULE_7__["closeModal"])('.popup_engineer');
          form.reset();
        });
      } else {
        Object(_service_service__WEBPACK_IMPORTED_MODULE_8__["postData"])('http://localhost:3000/call', object).then(function (data) {
          console.log(data);
          showThanksModal('.popup_engineer', message.success);
        }).catch(function () {
          showThanksModal('.popup_engineer', message.failure);
        }).finally(function () {
          Object(_modals__WEBPACK_IMPORTED_MODULE_7__["closeModal"])('.popup');
          form.reset();
        });
      }
    });
...
function showThanksModal(modalSelector, message) {
  ...
  var prevModalDialog = modal.querySelector('.popup_dialog');
  prevModalDialog.classList.remove('show');
  prevModalDialog.classList.add('hide');
  Object(_modals__WEBPACK_IMPORTED_MODULE_7__["openModal"])(modalSelector);
  var thanksModal = document.createElement('div');
  thanksModal.classList.add('popup_dialog');
  thanksModal.innerHTML = "\n      <div class=\"popup_content text-center\">\n          <button data-close class=\"popup_close\">\xD7</button>\n          <h2 class=\"popup__title\">".concat(message, "</h2>\n      </div>\n  ");
  document.querySelector(modalSelector).append(thanksModal);
  setTimeout(function () {
    thanksModal.remove();
    prevModalDialog.classList.add('show');
    prevModalDialog.classList.remove('hide');
    Object(_modals__WEBPACK_IMPORTED_MODULE_7__["closeModal"])(modalSelector);
  }, 4000);
}
...
function modals() {
  ...
  function bindModal(btnClass, modalSelector, closeSelector) {
    var closeClickOverlay = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    var triggerBtn = document.querySelectorAll(btnClass);
    var modal = document.querySelector(modalSelector);
